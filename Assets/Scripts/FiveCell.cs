...
public class FiveCell : MonoBehaviour
{
    ...
    void DrawFiveCell()
    {
        ...
        CreatePlane(rotatedVerts[1], rotatedVerts[2], rotatedVerts[3], rotatedVerts[3]);
        CreatePlane(rotatedVerts[1], rotatedVerts[2], rotatedVerts[4], rotatedVerts[4]);
        CreatePlane(rotatedVerts[1], rotatedVerts[3], rotatedVerts[4], rotatedVerts[4]);
        CreatePlane(rotatedVerts[2], rotatedVerts[3], rotatedVerts[4], rotatedVerts[3]);

        CreatePlane(rotatedVerts[1], rotatedVerts[0], rotatedVerts[2], rotatedVerts[2]);
        CreatePlane(rotatedVerts[1], rotatedVerts[0], rotatedVerts[3], rotatedVerts[3]);
        CreatePlane(rotatedVerts[1], rotatedVerts[0], rotatedVerts[4], rotatedVerts[4]);
        CreatePlane(rotatedVerts[0], rotatedVerts[2], rotatedVerts[3], rotatedVerts[3]);
        CreatePlane(rotatedVerts[0], rotatedVerts[3], rotatedVerts[4], rotatedVerts[4]);
        CreatePlane(rotatedVerts[0], rotatedVerts[4], rotatedVerts[2], rotatedVerts[2]);
    }
