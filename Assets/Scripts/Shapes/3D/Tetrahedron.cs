...
public class Tetrahedron : MonoBehaviour
{
    ...
    void DrawTetrahedron()
    {
        ...
        CreatePlane(rotatedVerts[0], rotatedVerts[1], rotatedVerts[2], rotatedVerts[2]);
        CreatePlane(rotatedVerts[0], rotatedVerts[2], rotatedVerts[3], rotatedVerts[3]);
        CreatePlane(rotatedVerts[0], rotatedVerts[1], rotatedVerts[3], rotatedVerts[3]);
        CreatePlane(rotatedVerts[2], rotatedVerts[1], rotatedVerts[3], rotatedVerts[3]);
